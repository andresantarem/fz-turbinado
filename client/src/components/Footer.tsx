        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex flex-col sm:flex-row items-center sm:items-start gap-2 text-foreground/70 hover:text-primary transition-colors text-center sm:text-left">
                <a href="https://wa.me/5562992960658?text=Tenho%20interesse%20nos%20widgets%20da%20Bravatus.%20Por%20favor%20entre%20em%20contato." target="_blank" rel="noopener noreferrer" className="flex items-center justify-center sm:justify-start gap-2">
